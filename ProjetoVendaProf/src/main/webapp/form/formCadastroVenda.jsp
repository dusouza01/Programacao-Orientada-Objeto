...
<body>
	<jsp:include page="../listarFuncionario"></jsp:include>
			...
			<form class="col s12" action="" method="post">
				...
				<div class="row">
					<button class="btn waves-effect waves-teal" type="submit">
						Cadastrar Venda<i class="material-icons right">send</i>
					</button>
				</div>
				<a class="btn waves-effect waves-teal" href="../index.jsp"> <i
					class="material-icons left">cloud</i>Voltar
				</a>
			</form>
		</div>
	</div>
